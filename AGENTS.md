...
- `agent_docs/CHANGELOG.md` is the release narrative and should explain upstream rebases, LiteLLM behavior changes, model support shifts, and migration steps.
- Release pages should be curated from `agent_docs/CHANGELOG.md`, not autogenerated, so users can judge whether a tag is safe to adopt.
- When setup, economics, or user-visible behavior changes, update `README.md` and `agent_docs/CHANGELOG.md` together.
